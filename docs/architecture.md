...
| **Series expand UI** | `src/components/SeriesExpander.tsx` | Curator panel in `PlaylistForm` to load a release from the indexer and append flat `PlaylistItem` leaves. |
